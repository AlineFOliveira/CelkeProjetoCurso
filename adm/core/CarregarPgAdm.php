...
class CarregarPgAdm
{
    ...
    public function loadPage(string|null $urlController, string|null $urlMetodo, string|null $urlParameter): void
    {
        ...
        if (class_exists($this->classLoad)) {
            ...
            die("Erro - 003: Por favor tente novamente. Caso o problema persista, entre em contato o administrador ");
    ...
    {
        $this->listPgPrivate = ["Dashboard", "ListUsers", "ViewUsers", "AddUsers", "EditUsers", "EditUsersPassword", "EditUsersImage", 'DeleteUsers', "ViewProfile", "EditProfile", "EditProfilePassword", "EditProfileImage", "ListSitsUsers", "ViewSitsUsers", "AddSitsUsers", "EditSitsUsers", "DeleteSitsUsers", "ListColors", "ViewColors", "AddColors", "EditColors", "DeleteColors", "ListConfEmails", "AddConfEmails", "ViewConfEmails", "EditConfEmails", "EditConfEmailsPassword", "DeleteConfEmails", "ListAccessLevels", "AddAccessLevels", "ViewAccessLevels", "EditAccessLevels", "DeleteAccessLevels", "OrderAccessLevels", "ListSitsPages", "ViewSitsPages", "EditSitsPages", "AddSitsPages", "DeleteSitsPages", "ListGroupsPages", "AddGroupsPages", "ViewGroupsPages", "EditGroupsPages", "DeleteGroupsPages", "OrderGroupsPages", "ListTypesPages", "AddTypesPages", "ViewTypesPages", "EditTypesPages", "DeleteTypesPages", "OrderTypesPages", "ListPages", "AddPages", "ViewPages", "EditPages", "DeletePages", "ListPermission", "SyncPagesLevels", "EditPermission", "EditPrintMenu"];

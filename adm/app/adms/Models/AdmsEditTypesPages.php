...
class AdmsEditTypesPages
{
    ...
    public function update(array $data = null): void
    {
        ...
        if ($valEmptyField->getResult()) {
            ...
            $_SESSION['msg'] = "<p class='alert-danger'>Erro: Tipo de página cadastrado com sucesso!</p>";
            $this->result = false;
        } 
    }
    ...
    private function edit(): void
    {
        ...
        $upGroup->exeUpdate("adms_types_pgs", $this->data, "WHERE id=:id", "id={$this->data['id']}");

        if ($upGroup->getResult()) {
            $_SESSION['msg'] = "<p class='alert-success'>Tipo de página editado com sucesso!</p><br>";
            $this->result = true;
        } else {

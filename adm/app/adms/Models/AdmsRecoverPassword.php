...
class AdmsRecoverPassword
{
    ...
    private function sendEmail(): void
    {
        ...
        if ($sendEmail->getResult()) {
            ...
            $_SESSION['msg'] = "<p style='color: #f00;'>Erro:N-mail com instruções para recuperar a senha não enviado, tente novamente ou entre em contato com o e-mail {$this->fromEmail}!</p>";
            $this->result = false;
        }
    }
    ...
    private function emailHTML(): void
    {
        ...
        $this->url = URL . "update-password/index?key=" . $this->resultBd[0]['recover_password'];
        ...
        $this->emailData['contentHTML'] .= "Se você não solicitou essa alteração, nenhuma ação é necessária.<br><br>";
    }
    ...
    private function emailText(): void
    {
        ...
        $this->emailData['contentText'] .= "Se você não solicitou essa alteração, nenhuma ação é necessária.";
    }
}

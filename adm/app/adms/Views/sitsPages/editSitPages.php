    ...
    <div class="row">
        <div class="top-list">
            ...
            <div class="top-list-right">
                ...
                if (isset($valorForm['id'])) {
                    echo "<a href='" . URL . "view-sits-pages/index/" . $valorForm['id'] . "' class='btn-primary'>Visualizar</a><br><br>";
                }
                ?>
            </div>
        </div>
        ...
        <div class="content-adm">
            <form method="POST" action="" id="form-add-sit-user" class="form-adm">
                ...
                <button type="submit" name="SendEditSitPage" class="btn-warning" value="Salvar">Salvar</button>

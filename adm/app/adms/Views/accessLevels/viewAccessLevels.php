    ...
    <div class="row">
        <div class="top-list">
            ...
            <div class="top-list-right">
                <?php
                echo "<a href='" . URL . "list-access-levels/index' class='btn-info'>Listar</a> ";
                if (!empty($this->data['viewAccessLevels'])) {
                    echo "<a href='" . URL . "edit-access-levels/index/" . $this->data['viewAccessLevels'][0]['id'] . "' class='btn-warning'>Editar</a> ";
                    
                    echo "<a href='" . URL . "delete-access-levels/index/" . $this->data['viewAccessLevels'][0]['id'] . "' onclick='return confirm(\"Tem certeza que deseja excluir este registro?\")' class='btn-danger'>Apagar</a> ";
                }
                ?>
            </div>
        </div>

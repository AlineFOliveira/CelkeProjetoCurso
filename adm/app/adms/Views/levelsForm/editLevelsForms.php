...
<div class="wrapper">
    <div class="row">
        <div class="top-list">
            <span class="title-content">Editar Configurações do Formulário</span>
            <div class="top-list-right">
                <?php

                    echo "<a href='" . URL . "view-levels-forms/index/" . $valorForm['id'] . "' class='btn-primary'>Visualizar</a><br><br>";
                ?>
            </div>
        </div>

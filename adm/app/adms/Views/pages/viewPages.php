        ...
        <div class="top-list">
            ...
            <div class="top-list-right">
                ...
                if ($this->data['button']['list_pages']) {
                    echo "<a href='" . URL . "list-pages/index' class='btn-info'>Listar</a> ";
                }
                if (!empty($this->data['viewPages'])) {
                    if ($this->data['button']['edit_pages']) {
                        echo "<a href='" . URL . "edit-pages/index/" . $this->data['viewPages'][0]['id'] . "' class='btn-warning'>Editar</a> ";
                    }
                    if ($this->data['button']['delete_pages']) {
                        echo "<a href='" . URL . "delete-pages/index/" . $this->data['viewPages'][0]['id'] . "' onclick='return confirm(\"Tem certeza que deseja excluir este registro?\")' class='btn-danger'>Apagar</a> ";
                    }
                }
                ?>
            </div>

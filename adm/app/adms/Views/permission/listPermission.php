    ...
    <div class="row">
        <div class="top-list">
            ...
            <div class="top-list-right">
                <?php
                echo "<a href='" . URL . "list-access-levels/index' class='btn-info'>Listar Nível de Acesso</a>";
                ?>
            </div>
        </div>
                ...
                ?>
                    <tr>
                        ...
                        <td class="list-body-content table-sm-none">
                            <?php
                            if ($permission == 1) {
                                echo "<a href='" . URL . "edit-permission/index/$id?&level=$adms_access_level_id&pag=" . $this->data['pag'] . "'><span class='text-success'>Liberado</span></a>";
                            } else {
                                echo "<a href='" . URL . "edit-permission/index/$id?&level=$adms_access_level_id&pag=" . $this->data['pag'] . "'><span class='text-danger'>Bloqueado</span></a>";
                            }
                            ?>
                        </td>
                        <td class="list-body-content table-md-none">
                            <?php
                            if ($print_menu == 1) {
                                echo "<a href='" . URL . "edit-print-menu/index/$id?&level=$adms_access_level_id&pag=" . $this->data['pag'] . "'><span class='text-success'>Liberado</span></a>";
                            } else {
                                echo "<a href='" . URL . "edit-print-menu/index/$id?&level=$adms_access_level_id&pag=" . $this->data['pag'] . "'><span class='text-danger'>Bloqueado</span></a>";
                            }
                            ?>
                        </td>
                            ...
                            <div class="dropdown-action">
                                ...
                                <div id="actionDropdown<?php echo $id; ?>" class="dropdown-action-item">
                                    <?php
                                        ...
                                        echo "<a href='" . URL . "order-page-menu/index/$id?&level=$adms_access_level_id&pag=" . $this->data['pag'] . "'><i class='fa-solid fa-angles-up'></i> Ordem</a>";

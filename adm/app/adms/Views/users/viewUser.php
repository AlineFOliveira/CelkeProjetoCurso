            ...
            <div class="top-list-right">
                ...
                if (!empty($this->data['viewUser'])) {
                    if ($this->data['button']['edit_users']) {
                        echo "<a href='" . URL . "edit-users/index/" . $this->data['viewUser'][0]['id'] . "' class='btn-warning'>Editar</a> ";
                    }
                    if ($this->data['button']['edit_users_password']) {
                        echo "<a href='" . URL . "edit-users-password/index/" . $this->data['viewUser'][0]['id'] . "' class='btn-warning'>Editar Senha</a> ";
                    }
                    if ($this->data['button']['edit_users_image']) {
                        echo "<a href='" . URL . "edit-users-image/index/" . $this->data['viewUser'][0]['id'] . "' class='btn-warning'>Editar Imagem</a> ";
                    }
                    if ($this->data['button']['delete_users']) {
                        echo "<a href='" . URL . "delete-users/index/" . $this->data['viewUser'][0]['id'] . "' onclick='return confirm(\"Tem certeza que deseja excluir este registro?\")' class='btn-danger'>Apagar</a> ";
                    }
                }
                ?>
            </div>
        ...
        <div class="content-adm">
            ...
            ?>
                <div class="view-det-adm">
                    ...
                    <span class="view-adm-info">
                        ...
                        if ((!empty($image)) and (file_exists("app/adms/assets/image/users/$id/$image"))) {
                            echo "<img src='" . URL . "app/adms/assets/image/users/$id/$image' width='100' height='100'><br><br>";
                        } else {
                            echo "<img src='" . URL . "app/adms/assets/image/users/icon_user.png' width='100' height='100'><br><br>";
                        }
                        ?>
                    </span>
                </div>
                ...
                <div class="view-det-adm">
                    ...
                    <span class="view-adm-info">
                        <?php echo "<a href='" . URL . "view-access-levels/index/$id_lev'>$name_lev</a>"; ?>
                    </span>
                </div>

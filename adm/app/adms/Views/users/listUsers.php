        ...
        <div class="top-list">
            ...
            <div class="top-list-right">
                ...
                if($this->data['button']['add_users']){
                    echo "<a href='" . URL . "add-users/index' class='btn-success'>Cadastrar</a>";
                }
                            ...
                            <div class="dropdown-action">
                                ...
                                <div id="actionDropdown<?php echo $id; ?>" class="dropdown-action-item">
                                    ...
                                    if($this->data['button']['view_users']){
                                        echo "<a href='" . URL . "view-users/index/$id'>Visualizar</a>";
                                    }
                                    if($this->data['button']['edit_users']){
                                        echo "<a href='" . URL . "edit-users/index/$id'>Editar</a>";
                                    }
                                    if($this->data['button']['delete_users']){
                                        echo "<a href='" . URL . "delete-users/index/$id' onclick='return confirm(\"Tem certeza que deseja excluir este registro?\")'>Apagar</a>";
                                    }

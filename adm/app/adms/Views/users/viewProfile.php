        ...
        <div class="top-list">
            ...
            <div class="top-list-right">
                ...
                if (!empty($this->data['viewProfile'])) {
                    echo "<a href='" . URL . "edit-profile/index' class='btn-warning'>Editar</a> ";
                    echo "<a href='" . URL . "edit-profile-password/index' class='btn-warning'>Editar Senha</a> ";
                    echo "<a href='" . URL . "edit-profile-image/index' class='btn-warning'>Editar Imagem</a> ";
                }
                ?>
            </div>
        </div>
                ...
                <div class="view-det-adm">
                    ...
                    <span class="view-adm-info">
                        ...
                        if ((!empty($image)) and (file_exists("app/adms/assets/image/users/" . $_SESSION['user_id'] . "/$image"))) {
                            echo "<img src='" . URL . "app/adms/assets/image/users/" . $_SESSION['user_id'] . "/$image' width='100' height='100'><br><br>";
                        }else{

        ...
        <div class="top-list">
            ...
            <div class="top-list-right">
                ...
                if ($this->data['button']['list_sits_users']) {
                    echo "<a href='" . URL . "list-sits-users/index' class='btn-info'>Listar</a> ";
                }


                if (!empty($this->data['viewSitUser'])) {
                    if ($this->data['button']['edit_sits_users']) {
                        echo "<a href='" . URL . "edit-sits-users/index/" . $this->data['viewSitUser'][0]['id'] . "' class='btn-warning'>Editar</a> ";
                    }
                    if ($this->data['button']['delete_sits_users']) {
                        echo "<a href='" . URL . "delete-sits-users/index/" . $this->data['viewSitUser'][0]['id'] . "' onclick='return confirm(\"Tem certeza que deseja excluir este registro?\")' class='btn-danger'>Apagar</a> ";
                    }
                }
                ?>
            </div>
...
if (!empty($this->data['viewSitUser'])) {
    echo "<a href='" . URL . "edit-sits-users/index/" . $this->data['viewSitUser'][0]['id'] . "'>Editar</a><br>";
    echo "<a href='" . URL . "delete-sits-users/index/" . $this->data['viewSitUser'][0]['id'] . "' onclick='return confirm(\"Tem certeza que deseja excluir este registro?\")'>Apagar</a><br>";

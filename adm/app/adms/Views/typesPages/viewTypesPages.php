        ...
        <div class="top-list">
            ...
            <div class="top-list-right">
                ...
                if ($this->data['button']['list_types_pages']) {
                    echo "<a href='" . URL . "list-types-pages/index' class='btn-info'>Listar</a> ";
                }
                if (!empty($this->data['viewTypesPages'])) {
                    if ($this->data['button']['edit_types_pages']) {
                        echo "<a href='" . URL . "edit-types-pages/index/" . $this->data['viewTypesPages'][0]['id'] . "' class='btn-warning'>Editar</a> ";
                    }
                    if ($this->data['button']['delete_types_pages']) {
                        echo "<a href='" . URL . "delete-types-pages/index/" . $this->data['viewTypesPages'][0]['id'] . "' onclick='return confirm(\"Tem certeza que deseja excluir este registro?\")' class='btn-danger'>Apagar</a> ";
                    }
                }
                ?>
            </div>

        ...
        <div class="top-list">
            ...
            <div class="top-list-right">
                ...
                if ($this->data['button']['add_types_pages']) {
                    echo "<a href='" . URL . "add-types-pages/index' class='btn-success'>Cadastrar</a>";
                }
                ?>
            </div>
        </div>
                            ...
                            <div class="dropdown-action">
                                ...
                                <div id="actionDropdown<?php echo $id; ?>" class="dropdown-action-item">
                                    ...
                                    if ($this->data['button']['order_types_pages']) {
                                        echo "<a href='" . URL . "order-types-pages/index/$id?pag=" . $this->data['pag'] . "'><i class='fa-solid fa-angles-up'></i> Ordem</a>";
                                    }
                                    if ($this->data['button']['view_types_pages']) {
                                        echo "<a href='" . URL . "view-types-pages/index/$id'><i class='fa-solid fa-eye'></i> Visualizar</a>";
                                    }
                                    if ($this->data['button']['edit_types_pages']) {
                                        echo "<a href='" . URL . "edit-types-pages/index/$id'><i class='fa-solid fa-pen-to-square'></i> Editar</a>";
                                    }
                                    if ($this->data['button']['delete_types_pages']) {
                                        echo "<a href='" . URL . "delete-types-pages/index/$id' onclick='return confirm(\"Tem certeza que deseja excluir este registro?\")'><i class='fa-solid fa-trash-can'></i> Apagar</a>";
                                    }
                                    ?>
                                </div>
                            </div>

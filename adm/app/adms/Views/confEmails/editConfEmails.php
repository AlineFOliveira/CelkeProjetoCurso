        ...
        <div class="top-list">
            ...
            <div class="top-list-right">
                ...
                if (isset($valorForm['id'])) {
                    echo "<a href='" . URL . "view-conf-emails/index/" . $valorForm['id'] . "' class='btn-primary'>Visualizar</a> ";
                    echo "<a href='" . URL . "edit-conf-emails-password/index/" . $valorForm['id'] . "' class='btn-warning'>Editar Senha</a> ";
                    echo "<a href='" . URL . "delete-conf-emails/index/" . $valorForm['id'] . "' onclick='return confirm(\"Tem certeza que deseja excluir este registro?\")' class='btn-danger'>Apagar</a> ";
                }
                ?>
            </div>
        </div>

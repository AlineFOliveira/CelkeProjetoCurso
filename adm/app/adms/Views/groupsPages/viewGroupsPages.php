        ...
        <div class="top-list">
            ...
            <div class="top-list-right">
                ...
                if ($this->data['button']['list_groups_pages']) {
                    echo "<a href='" . URL . "list-groups-pages/index' class='btn-info'>Listar</a> ";
                }
                if (!empty($this->data['viewGroupsPages'])) {
                    if ($this->data['button']['edit_groups_pages']) {
                        echo "<a href='" . URL . "edit-groups-pages/index/" . $this->data['viewGroupsPages'][0]['id'] . "' class='btn-warning'>Editar</a> ";
                    }
                    if ($this->data['button']['delete_groups_pages']) {
                        echo "<a href='" . URL . "delete-groups-pages/index/" . $this->data['viewGroupsPages'][0]['id'] . "' onclick='return confirm(\"Tem certeza que deseja excluir este registro?\")' class='btn-danger'>Apagar</a> ";
                    }
                }
                ?>
            </div>
